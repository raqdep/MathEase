...
async function completeLesson(lessonNum) {
    try {
        ...
        if (data.success) {
            ...
            showError(data.message || 'Failed to complete lesson');
        ...
        showError('Error completing lesson. Please try again.');
...
function showTopicCompletionOption() {
    // This would show a modal or notification that all lessons are completed
    // For now, just show a success message
    showSuccess('Congratulations! You have completed all lessons in Operations on Functions!');
}
